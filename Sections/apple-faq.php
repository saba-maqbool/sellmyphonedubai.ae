...
// A page can show its own FAQ set (instead of the global one) by setting
// $faq_section_key before including this file — e.g. apple-page.php sets
// it to 'apple_faq' so it doesn't mix with the homepage FAQs.
$faq_section_key = $faq_section_key ?? 'faq';
...
mysqli_stmt_bind_param($stmt, "s", $faq_section_key);
