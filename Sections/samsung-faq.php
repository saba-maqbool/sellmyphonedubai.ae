...
$faq_section_key = $faq_section_key ?? 'samsung_faq';

$faq_section = [
    'kicker' => 'FAQ',
    'heading' => 'Frequently Asked Questions',
    'description' => 'Everything you need to know before you sell your Samsung phone in Dubai',
];
$faq_items = [];
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    <?php foreach ($faq_items as $index => $item): ?>
    {
      ...
      "acceptedAnswer": { "@type": "Answer", "text": <?php echo json_encode($item['subtitle']); ?> }
