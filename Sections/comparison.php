<section class="comparison-section" id="comparison-section">
    <div class="section-header">
        <span class="section-tag"><i class="fa-solid fa-check"></i> THE SMARTER ALTERNATIVE</span>
        <h2 class="section-title">SellMyPhoneDubai vs <span>Traditional Selling Options</span></h2>
        <p class="section-subtitle">See why thousands of Dubai phone owners choose our direct service over retail stores, classified boards, and carrier trade-ins.</p>
    </div>
