...
// Recent posts: latest 5 published posts, excluding the current one
$related_posts = [];
if ($post) {
...
// Rough read-time estimate (based on ~200 words/min)
$read_minutes = 1;
if ($post) {
...
<section class="blog-details" id="blog-details">
    <?php if ($post): ?>
        <a href="blogs" class="blog-back-link"><i class="fas fa-arrow-left"></i> Back to Blogs</a>
        ...
        <div class="blog-details-layout">
            ...
            <aside class="blog-related">
                ...
                <div class="blog-related-list">
                    ...
                    <a href="blog-details/<?php echo urlencode($rp['slug']); ?>" class="blog-related-item">
                        <div class="blog-related-img">
                            <img src="<?php echo htmlspecialchars($rp['image'] ?: 'imgs/hero.webp'); ?>" alt="<?php echo htmlspecialchars($rp['title']); ?>">
                        </div>
    ...
    <?php else: ?>
        <div id="noResults" class="no-results" style="display: block;">
            ...
            <a href="blogs" class="blog-card-link" style="margin-top:16px;">Back to Blog <i class="fas fa-arrow-right"></i></a>
        </div>
    <?php endif; ?>
</section>