...
<section class="apple-cta-section">
    <div class="apple-cta-box">
        <div class="apple-cta-text">
            <h3 class="apple-cta-heading">Ready to Sell Your Samsung Device?</h3>
        ...
        <div class="apple-cta-actions">
            <a href="#samsung-catalog-wrap" class="apple-hero-btn-primary" onclick="showSamsungCatalog(event)">Get Instant Quote <i class="fa-solid fa-arrow-right"></i></a>
